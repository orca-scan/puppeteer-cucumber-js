...
--browser <path>                # name of browser to use. defaults to chrome
--browser-teardown <optional>   # browser teardown after every scenario (always, clear, none). default "always"
